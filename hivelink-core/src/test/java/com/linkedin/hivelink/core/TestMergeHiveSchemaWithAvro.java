...
import com.linkedin.hivelink.core.schema.MergeHiveSchemaWithAvro;
...
public class TestMergeHiveSchemaWithAvro {
  ...
  public void shouldRetainDefaultValuesFromAvro() {
    String hive = "struct<fa:int,fb:struct<ga:int>>";
    Schema avro = struct("r1", required("fA", Schema.Type.INT, null, 1, null), required("fB",
        struct("r2", required("gA", Schema.Type.INT, null, 2, null)), null, fromJson("{\"gA\": 3}"), null));
  ...
  public void shouldReorderOptionalSchemaToMatchDefaultValue() {
    String hive = "struct<fa:int,fb:struct<ga:int>>";
    Schema avro = struct("r1",
        field("fA", Schema.createUnion(Schema.create(Schema.Type.INT), Schema.create(Schema.Type.NULL)), null, 1, null),
        field("fB", Schema.createUnion(struct("r2", required("gA", Schema.Type.INT, null, 2, null)),
            Schema.create(Schema.Type.NULL)), null, fromJson("{\"gA\": 3}"), null));
  ...
  public void shouldRecoverLogicalType() {
    ...
    Schema expected = struct("r1", optional("fa", LogicalTypes.date().addToSchema(Schema.create(Schema.Type.INT))),
    ...
    Assert.assertEquals("date", AvroSchemaUtil.fromOption(merged.getField("fa").schema()).getLogicalType().getName());
  ...
  private Schema.Field nullable(Schema.Field field) {
    ...
    return field(field.name(), nullable(field.schema()), field.doc(), Schema.Field.NULL_DEFAULT_VALUE,
