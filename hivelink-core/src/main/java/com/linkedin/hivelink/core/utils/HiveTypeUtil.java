 ...
 */
package com.linkedin.hivelink.core.utils;
...
import com.linkedin.hivelink.core.HiveTypeToIcebergType;
  ...
  public static <T> T visit(TypeInfo typeInfo, HiveSchemaVisitor<T> visitor) {
    switch (typeInfo.getCategory()) {
      ...
      case MAP:
        ...
        return visitor.map(mapTypeInfo, visit(mapTypeInfo.getMapKeyTypeInfo(), visitor),
